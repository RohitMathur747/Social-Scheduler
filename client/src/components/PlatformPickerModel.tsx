...
const PlatformPickerModel = ({
  ...
  return (
    <div className="fixed inset-0 z-50 items-center justify-center p-4 bg-slate-900/40 backdrop-blur">
          ...
          {PLATFORMS.map((p) => {
            ...
            return (
              ...
              >
                ...
                {isConnecting && (
                  <div className="size-4 border-2 border-red-600 border-t-transparent rounded-full animated-spin shrink-0" />
                )}
